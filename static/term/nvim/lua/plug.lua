...
local function init()
      ...
      require("Dusk-til-Dawn").timeMan(
        function()
          require('indent_guides').setup({
            even_colors = {fg = "#efeae9", bg = "#efeae9"},
            odd_colors = {fg = "#e3dedd", bg = "#e3dedd"},
            indent_guide_size = 4
          })
        ...
        function()
          require('indent_guides').setup({
            even_colors = {fg = "#212026", bg = "#212026"},
            odd_colors = {fg = "#42444a", bg = "#42444a"},
            indent_guide_size = 4
          })
          require('indent_guides').indent_guides_enable()
        end
  ...
  use {
    ...
    config = function()
      ...
      api.nvim_set_keymap('n', '<C-h>', ':TmuxNavigateLeft<cr>', { noremap = true, silent = true })
      api.nvim_set_keymap('n', '<C-j>', ':TmuxNavigateDown<cr>', { noremap = true, silent = true })
      api.nvim_set_keymap('n', '<C-k>', ':TmuxNavigateUp<cr>', { noremap = true, silent = true })
      api.nvim_set_keymap('n', '<C-l>', ':TmuxNavigatePrevious<cr>', { noremap = true, silent = true })
      --api.nvim_set_keymap('n', '<S-Tab>', ':TmuxNavigatePrevious<cr>', { noremap = true, silent = true })
    end
    --]]
  }
