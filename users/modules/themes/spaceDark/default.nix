  ...
  config = mkIf (cfg.name == "Space Dark") (mkMerge [
    {
      home.theme = {
        ...
        vt = {
          red =
            "0x29,0xaf,0x00,0xd7,0x87,0x87,0x0d,0xb2,0x29,0xf2,0x23,0xff,0x1a,0xd7,0x14,0xf";
          grn =
            "0x2b,0x87,0x99,0xaf,0xaf,0x5f,0xcd,0xb2,0x2b,0x20,0xfd,0xfd,0x8f,0x5f,0xff,0xff";
          blu =
    ...
    (mkIf cfp.bat.enable { programs.bat.config = { theme = "TwoDark"; }; })
